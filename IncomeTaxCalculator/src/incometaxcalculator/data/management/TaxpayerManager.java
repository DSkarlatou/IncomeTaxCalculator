...
public class TaxpayerManager {
  ...
  String[] taxpayerKinds = {"Married Filing Jointly", "Married Filing Separately", "Single", "Head of Household"};
  ...
  public void createTaxpayer(String fullname, int taxRegistrationNumber, String status,
    ...
    Taxpayer taxpayer = (new TaxpayerFactory()).createTaxpayer(fullname, taxRegistrationNumber, status, income);
  ...
  public void addReceipt(int receiptId, String issueDate, float amount, String kind,
    ...
    if (containsReceipt(receiptId)) {
      Taxpayer currentTaxpayer = this.getTaxpayer(taxRegistrationNumber);
      HashMap<Integer, Receipt> receiptHashMap = currentTaxpayer.getReceiptHashMap();
      if(receiptHashMap.keySet().contains(receiptId))
  ...
  public void updateFiles(int taxRegistrationNumber) throws IOException {
    InfoWriter infoWriter = (new InfoWriterFactory()).infoWriter(taxRegistrationNumber); 
  ...
  public void saveLogFile(int taxRegistrationNumber, String fileFormat)
    ...
    FileWriter writer = (new LogWriterFactory()).logWriter(fileFormat);
  ...
  public void loadTaxpayer(String fileName)
    ...
    FileReader reader = (new FileReaderFactory()).fileReader(ending[1]);
